...
<section class="s-gallery" id="s-gallery">
	<div class="container">
		<h3 class="center-title wow fadeIn" data-wow-delay="0.1s">NHSMUN50 - New York, USA <span <i style='font-size:24px' class='fas'>&#xf74d;</i></span> 2024</h3>
				...
				<div id="textoOriginal">
					...
					<div style="text-align:justify" class="def-desc wow fadeInLeft" data-wow-delay="0.3s">
						<div class="contenido">
							...
							<button1 onclick="toggleText()" id="toggle-button">Leer mas...</button1>
						</div>
						</div>
					</div>
					...
					<div style="text-align:justify" class="def-desc wow fadeInLeft" data-wow-delay="0.3s">
						<div class="contenido">
							...
							<button1 onclick="toggleText()" id="toggle-button-en">Read more...</button1>
						</div>
						</div>
					</div>
					<button2 class="wow fadeInLeft" data-wow-delay="0.2s" id="botonTraduccion">Read in English</button2>
				</div>
