...
// BOTON SHOW Y HIDE DE LA GALERIA 1
	...
	// BOTON SHOW Y HIDE DE LA GALERIA 2
	$('.gallery-btns a').on('click', function(e) {
		e.preventDefault();
		var galleryItem = $('.gallery-items');
		...
		// BOTON SHOW Y HIDE DE LA GALERIA 3
	$('.gallery-btn3 a').on('click', function(e) {
		e.preventDefault();
		var galleryItem = $('.gallery-items3');
